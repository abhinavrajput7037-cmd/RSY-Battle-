...
public class MainActivity extends AppCompatActivity implements Observer,
    ...
    // Start.io Ads
    private StartioAdManager startioAdManager;

    // ---- Start.io Ads (add AAR to libs/ to enable) ----
    // ---- End Start.io ----
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Start.io Ads
        startioAdManager = new StartioAdManager(this);
        startioAdManager.init("203602066");

        // ---- Start.io SDK Init (uncomment after placing AAR in libs/) ----
        // ---- End Init ----
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
            if (!Settings.canDrawOverlays(this)) {
                android.content.Intent overlayIntent = new android.content.Intent(
                    Settings.ACTION_MANAGE_OVERLAY_PERMISSION,
                    android.net.Uri.parse("package:" + getPackageName()));
                startActivity(overlayIntent);
            } else {
                // Auto-start floating button
                new android.os.Handler(android.os.Looper.getMainLooper()).postDelayed(() -> {
                    try {
                        android.content.Intent floatSvc = new android.content.Intent(this, FloatingService.class);
    ...
    protected void onPause() {
        ...
        if (startioAdManager != null) startioAdManager.onPause();
        // ---- Start.io: pause (uncomment after AAR added) ----
        // ---- End ----
    ...
    protected void onResume() {
        ...
        if (startioAdManager != null) startioAdManager.onResume();
    }
    ...
    public void checkNavigationForPage(String url) {
        ...
        if (startioAdManager != null) startioAdManager.onPageLoaded();
